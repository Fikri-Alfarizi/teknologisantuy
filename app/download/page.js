    ...
    <div className="download-page">
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .container { max-width: 1280px; margin-left: auto; margin-right: auto; padding-left: 0.75rem; padding-right: 0.75rem; }
        ...
        @media (min-width: 768px) { .nav-bar { height: 64px; } }
        .logo { font-size: 1rem; font-weight: 900; letter-spacing: -0.025em; color: var(--primary); }
        ...
        .progress-bar-container { position: fixed; top: 56px; left: 0; width: 100%; height: 4px; background-color: var(--surface-container); z-index: 50; }
        @media (min-width: 768px) { .progress-bar-container { top: 64px; } }
        ...
        .article-title { font-size: 1.5rem; font-weight: 900; color: var(--primary); line-height: 1.2; margin-bottom: 1.5rem; }
        ...
        .article-body { font-family: 'Inter', sans-serif; font-size: 0.95rem; line-height: 1.625; color: var(--on-background); }
        @media (min-width: 768px) { .article-body { font-size: 1.025rem; } }
        @media (min-width: 1024px) { .article-body { font-size: 1.125rem; } }
        ...
        .article-body h2 { font-family: 'Inter', sans-serif; font-weight: 700; font-size: 1.25rem; color: var(--primary); margin: 1.5rem 0 0.75rem; }
        @media (min-width: 768px) { .article-body h2 { font-size: 1.5rem; margin: 2rem 0 1rem; } }
        .article-body h3 { font-family: 'Inter', sans-serif; font-weight: 700; font-size: 1.1rem; color: var(--primary); margin: 1.25rem 0 0.5rem; }
        @media (min-width: 768px) { .article-body h3 { font-size: 1.25rem; margin: 1.5rem 0 0.75rem; } }
        ...
        .blockquote-text { font-size: 1.1rem; font-style: italic; color: var(--primary); line-height: 1.35; font-weight: 500; }
        @media (min-width: 768px) { .blockquote-text { font-size: 1.25rem; } }
        @media (min-width: 1024px) { .blockquote-text { font-size: 1.5rem; } }
        ...
        .comment-area { background-color: var(--surface); border-radius: 0.75rem; padding: 1rem; }
        @media (min-width: 768px) { .comment-area { padding: 1.5rem; } }
        @media (min-width: 1024px) { .comment-area { padding: 2rem; } }
        ...
        .footer { background-color: #e8e8ea; margin-top: 3rem; padding: 1.5rem; }
        @media (min-width: 640px) { .footer { padding: 2.5rem 1.5rem; } }
        ...
        .newsletter { background-color: var(--primary); color: white; border-radius: 0.75rem; padding: 1.5rem; position: relative; overflow: hidden; }
        @media (min-width: 768px) { .newsletter { padding: 2rem; } }
        ...
        .sidebar-sticky { display: flex; flex-direction: column; gap: 2rem; }
        @media (min-width: 768px) { .sidebar-sticky { position: sticky; top: 90px; } }
        .inline-ad { display: flex; justify-content: center; margin: 1.5rem 0; padding: 1rem 0; border-top: 1px solid #e8e8ea; border-bottom: 1px solid #e8e8ea; background: linear-gradient(135deg, #f3f4f6 0%, #f9f9fc 100%); border-radius: 0.75rem; }
        @media (min-width: 768px) { .inline-ad { margin: 2.5rem 0; padding: 1.5rem 0; } }
        ...
        @media (max-width: 768px) { .download-widget { position: static !important; width: 100% !important; margin: 1.5rem 0; right: auto !important; top: auto !important; max-width: 100% !important; } }
        @media (max-width: 640px) { .download-widget { position: static !important; width: 100% !important; margin: 1rem 0; max-width: 100% !important; } }
        @keyframes pulse { 0%, 100% { opacity: 1; } 50% { opacity: 0.5; } }
        .article-header { padding: 1rem; }
        @media (min-width: 640px) { .article-header { padding: 1.5rem; } }
        @media (min-width: 1024px) { .article-header { padding: 2rem; } }
        .article-content { padding: 1rem; }
        @media (min-width: 640px) { .article-content { padding: 1.5rem; } }
        @media (min-width: 1024px) { .article-content { padding: 2rem; } }
        .article-section { padding: 1rem; }
        @media (min-width: 640px) { .article-section { padding: 1.5rem; } }
        @media (min-width: 1024px) { .article-section { padding: 2rem; } }
      `}</style>
      ...
      <div className="download-widget" style={{ position: 'fixed', right: '0.75rem', top: '5rem', zIndex: 40, width: 'calc(100% - 1.5rem)', maxWidth: '340px', display: 'block' }}>
      ...
      <main className="container" style={{ marginTop: '4rem', paddingBottom: '1.5rem' }}>
        ...
        <div className="two-columns">
          <article className="article-card">
            <header style={{ borderBottom: '1px solid #e8e8ea' }} className="article-header">
            ...
            <div className="article-body article-content">
              ...
              <div className="inline-ad" style={{ background: '#f3f4f6', borderRadius: '1rem', border: '1px solid #e2e8f0', padding: '1rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div className="article-section" style={{ borderTop: '1px solid #e8e8ea', marginTop: '1rem' }}>
            ...
            <div className="comment-area" style={{ padding: '1.5rem', background: 'linear-gradient(135deg, #f0f4ff 0%, #e8f0ff 100%)', border: '2px solid #d6e3ff' }}>
