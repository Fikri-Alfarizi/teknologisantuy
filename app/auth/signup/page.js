...
export default function SignupPage() {
  ...
  const { signUp, signInWithGoogle, signInAsAnonymous, loading, error } = useAuth();
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      console.error("[DETIL ERROR SIGNUP EMAIL]:", err, err.code, err.message);
  ...
  const handleGoogleSignup = async () => {
    try {
      ...
      console.error("[DETIL ERROR SIGNUP GOOGLE]:", err, err.code, err.message);
      setLocalError(`Error [${err.code || 'UNKNOWN'}]: ${err.message}`);
    } finally {
      setIsLoading(false);
    }
  ...
  const handleAnonymousSignup = async () => {
    try {
      ...
      console.error("[DETIL ERROR SIGNUP ANONIM]:", err, err.code, err.message);
      setLocalError(`Error [${err.code || 'UNKNOWN'}]: ${err.message}`);
    } finally {
      setIsLoading(false);
    }
    ...
    <div className="auth-page-wrapper">
      ...
      <div className="auth-container">
        <div className="auth-header">
          ...
          <p>Daftar dan bergabung dengan komunitas</p>
        </div>
        ...
        <div className="auth-body">
          ...
          <div className="social-login">
            <button type="button" onClick={handleGoogleSignup} disabled={isLoading} className="btn-secondary">
              <FaGoogle /> Daftar dengan Google
            </button>

            <button type="button" onClick={handleAnonymousSignup} disabled={isLoading} className="btn-secondary btn-anon">
              <FaUser /> Masuk Anonim
            </button>
          </div>
        </div>
